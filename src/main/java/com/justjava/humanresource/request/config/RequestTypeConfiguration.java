...
@Configuration public class RequestTypeConfiguration {
 @Bean ApplicationRunner seedRequestTypes(WorkflowRequestTypeRepository repo){return args->{seed(repo,RequestType.STAFF_REQUISITION,"Staff Requisition",false,false,"staffRequisitionRequestHandler");seed(repo,RequestType.FILE_REQUEST,"File Request",true,false,"fileRequestHandler");seed(repo,RequestType.ASSET_REQUEST,"Asset Request",false,true,"assetRequestHandler");seed(repo,RequestType.GENERAL_REQUEST,"General Request",false,false,"generalRequestHandler");};}
